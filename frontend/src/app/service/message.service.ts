...
export class MessageService {
  ...
  findById(id: number) {
    return this.apiService.get(
      this.configService.getFindByMessageIdUrl + "/" + id
    );
  }

  create(message: MessageResponseDTO) {
    return this.apiService.post(
      this.configService.getCreateMessageUrl,
      message
    );
  }
  ...
  update(id: number, message: MessageResponseDTO) {
    return this.apiService.put(
      this.configService.getUpdateMessageUrl + "/" + id,
      message
    );
  }
  ...
  delete(id: number) {
    return this.apiService.delete(
      this.configService.getDeleteMessageUrl + "/" + id,
      id
    );
  }
}
