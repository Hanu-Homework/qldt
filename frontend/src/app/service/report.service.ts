...
export class ReportService {
  ...
  getSemesterResultByStudent(
    ...
    return this.apiService.post(
      this.configService.getGetSemesterResultByStudentUrl +
        "/" +
        student_id +
        "/" +
        year,
  ...
  findById(id: number) {
    return this.apiService.get(
      this.configService.getFindReportByIdUrl + "/" + id
    );
  }
  ...
  update(id: number, report: ReportResponseDTO) {
    return this.apiService.put(
      this.configService.getUpdateReportUrl + "/" + id,
      report
    );
  }
  ...
  delete(id: number) {
    return this.apiService.delete(
      this.configService.getDeleteReportUrl + "/" + id,
      id
    );
  }
  ...
  makeReportFormToClassroom(classroom_id: number) {
    return this.apiService.get(
      this.configService.getMakeReportFormToClassroomUrl + "/" + classroom_id
    );
  }

  createReportsToClassroom(reports: ReportResponseDTO[]) {
    return this.apiService.post(
      this.configService.getCreateReportsToClassroomUrl,
      reports
    );
  }
}
