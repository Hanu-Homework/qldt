...
export class TeacherService {
  ...
  findById(id: number) {
    return this.apiService.get(
      this.configService.getFindTeacherById + "/" + id
    );
  }

  findByUserId(user_id: number) {
    return this.apiService.get(
      this.configService.getFindTeacherByUserId + "/" + user_id
    );
  }
  ...
  create(teacher: TeacherResponseDTO) {
    return this.apiService.post(
      this.configService.getCreateTeacherUrl,
      teacher
    );
  }
  ...
  update(id: number, teacher: TeacherResponseDTO) {
    return this.apiService.put(
      this.configService.getUpdateTeacherUrl + "/" + id,
      teacher
    );
  }
  ...
  setCourse(teacher_id: number) {
    return this.apiService.put(
      this.configService.getSetCourseToTeacherUrl + "/" + teacher_id,
      teacher_id
    );
  }
  ...
  delete(id: number) {
    return this.apiService.delete(
      this.configService.getDeleteTeacherUrl + "/" + id,
      id
    );
  }

  setTeacherPreferences(
    teacherPreferenceResponseDTO: TeacherPreferenceResponseDTO
  ) {
    return this.apiService.put(
      this.configService.getSetTeacherPreferencesUrl,
  ...
  getAllTeacherPreferences(teacher_id: number) {
    return this.apiService.get(
      this.configService.getGetAllTeacherPreferencesUrl + "/" + teacher_id,
      teacher_id
    );
  }
}
