...
export class StudentService {
  ...
  create(student: StudentResponseDTO) {
    return this.apiService.post(
      this.configService.getCreateStudentUrl,
      student
    );
  }
  ...
  update(id: number, student: StudentResponseDTO) {
    return this.apiService.put(
      this.configService.getUpdateStudentUrl + "/" + id,
      student
    );
  }
  ...
  delete(student_id: number) {
    return this.apiService.delete(
      this.configService.getDeleteStudentUrl + "/" + student_id,
      student_id
    );
  }
  ...
  summary(id: number) {
    return this.apiService.get(
      this.configService.getSummaryStudentUrl + "/" + id
    );
  }
}
