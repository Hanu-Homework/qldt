...
export class RemarkService {
  ...
  findAll(student_id: number) {
    return this.apiService.get(
      this.configService.getFindAllRemarksUrl + "/" + student_id
    );
  }

  findById(id: number) {
    return this.apiService.get(
      this.configService.getFindByRemarkIdUrl + "/" + id
    );
  }
  ...
  update(id: number, remark: RemarkResponseDTO) {
    return this.apiService.put(
      this.configService.getUpdateRemarkUrl + "/" + id,
      remark
    );
  }
  ...
  delete(id: number) {
    return this.apiService.delete(
      this.configService.getDeleteRemarkUrl + "/" + id,
      id
    );
  }
}
